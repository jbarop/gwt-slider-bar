...
public class Description extends AbsolutePanel {
  ...
  public Description() {
    ...
    html.setHTML("With help of <b>SliderBar</b> framework You can utilize set of ready to use sliderbars or <u><i>easy create</i></u> your own sliderbars.<br><br>"
        + "It is possible to interracr with scrollbars by all availabble means:<br>"
        + "I.   drag knob <br>"
        + "II.  clic mouse on scale or on scale arrows<br> "
        + "III. use arrow keys on clipboard<br>" + "IV.  use mouse wheel");
    this.add(html, 5, 5);
  }
