...
public class Title extends AbsolutePanel {
  ...
  Anchor wikiMainPageRef = new Anchor("Getting started", false,
      "http://code.google.com/p/gwt-slider-bar/");
  Anchor downloadPageRef = new Anchor("Download", false,
      "http://code.google.com/p/gwt-slider-bar/downloads/list");
  Anchor sourcePageRef = new Anchor("Source", false,
      "http://code.google.com/p/gwt-slider-bar/source/checkout");
  Anchor mailMe = new Anchor("Mail me: kiouri@gmail.com", false, "mailto:kiouri@gmail.com");
  ...
  public Title() {
    ...
    mailMe.addStyleName("mailme");
    this.add(mailMe, 750, 78);
