...
public class AdvancedSliderBar extends SliderBarHorizontal {
  ...
  public AdvancedSliderBar() {
    ...
    Widget less = new MAdvancedTextPanel(new Image(images.lessNotSelected()), new Image(
        images.lessSelected()));

    Widget more = new MAdvancedTextPanel(new Image(images.moreNotSelected()), new Image(
        images.moreSelected()));
