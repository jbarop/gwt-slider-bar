...
public class MAdvancedTextPanel extends TouchableAbsolutePanelPK {
  ...
  protected void onLoad() {
    super.onLoad();
    this.setPixelSize(Math.max(selectedImage.getOffsetWidth(), notSelectedImage.getOffsetWidth()),
        Math.max(selectedImage.getOffsetHeight(), notSelectedImage.getOffsetHeight()));
  }
