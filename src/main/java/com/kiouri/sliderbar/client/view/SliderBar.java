...
/**
 * 
 * @author kiouri The base class for Horizontal and Vertical SliderBar
 * 
 */
public abstract class SliderBar extends FocusPanel implements Display {
  ...
  protected ArrayList<Widget> less = new ArrayList<Widget>(), more = new ArrayList<Widget>(),
   ...
   * @param scaleSize - height of scale for horizontal sliderbar or width of scale for vertical
   *          sliderbar.<br>
  ...
  /**
   * With help of this method it is possible to control appearance of outline border around the
   * sliderbar when sliderbar is in focus.
   */
  ...
  /**
   * 
   * @return max possible value which knob may point to. This value corresponds to rightmost knob
   *         position for horizontal sliderbar or bottommost knob position for vertical sliderbar
   */
  ...
  /**
   * Sets value which corresponds to rightmost position of knob for horizontal sliderbar o
   * bottommost position for vertical sliderbar.
   * 
   * @param maxValue
   */
  ...
  /**
   * Sets minimal distance between scale marks in pixels. If distance between marks will be less
   * then this value - marks will not be drowning.
   * 
   * @param minMarkStep
   */
